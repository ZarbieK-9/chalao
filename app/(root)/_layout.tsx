    ...
    <Tabs
      screenOptions={({ route }) => ({
        ...
        tabBarStyle: {
          ...
          height: isLandscape ? 60 : isSmallDevice ? 60 : 90,
          paddingBottom: isLandscape ? 5 : isSmallDevice ? 5 : 20,
          paddingTop: 1,
        },
        headerShown: false,
        tabBarItemStyle: {
          paddingVertical: isLandscape ? 5 : isSmallDevice ? 5 : 8,
        },
        tabBarLabelStyle: {
          fontFamily: "Poppins-Medium",
          fontSize: isLandscape ? 10 : isSmallDevice ? 10 : 12,
          marginTop: isLandscape ? 0 : isSmallDevice ? 2 : 4,
        },
